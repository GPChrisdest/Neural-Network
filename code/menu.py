...
def create_main_window():
    ...
    global root
    root=Tkinter.Tk()
    root.title("Hand written numbers detector")
    ...
    #photo layaout
    image=Tkinter.PhotoImage(file="LogoVersionEN.gif")
...
def check():
    ...
    check_root.title("Hand written numbers detector")
    ...
    yes_button=Tkinter.Button(check_root,text="Select this photo",command=start,width=15,height=4,bg="#D3D9D4",font=("Helvetica",10,"bold"))
    no_button=Tkinter.Button(check_root,text="Move to next photo",command=pk.view,width=15,height=4,bg="#D3D9D4",font=("Helvetica",10,"bold"))
    exit1_button=Tkinter.Button(check_root, text="Back to main menu",command=back,width=15,height=4,bg="#D3D9D4",font=("Helvetica",10,"bold"))
